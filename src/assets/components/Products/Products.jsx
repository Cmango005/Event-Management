...
const Products = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mx-auto container">
          ...
          <div className="card w-96 h-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <Link to="/iphone"><button className="btn btn-secondary hover:text-white">Latest iPhones</button></Link>
              </div>
            </div>
          </div>
        </div>
